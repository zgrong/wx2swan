 ...
 * @author yican
 */
var tips = '是个二级API，目前swan还不支持，so sad(ノへ￣、)，需要棒棒的你手动兼容下它和它返回值的api哦 ╮（﹀_﹀）╭ ';
/**
...
module.exports = {
    ...
    wx: {
        ...
        createAudioContext: (0, _extends3.default)({}, defaultConf, {
            message: tips
        }),
        createLivePusherContext: (0, _extends3.default)({}, defaultConf, {
            message: tips
        }),
        ...
        createContext: (0, _extends3.default)({}, defaultConf, {
            message: '被废弃的函数，建议使用createCanvasContext替代'
        }),
        drawCanvas: (0, _extends3.default)({}, defaultConf, {
            message: '被废弃的函数，建议使用createCanvasContext替代'
        }),
        ...
        login: (0, _extends3.default)({}, defaultConf, {
